...
export const home = {
  en: {
    ...
    found: { eyebrow: 'Be Found — what’s in it', h2: 'What Found includes.', lede: 'Everything that has to be true before your phone can ring. Eight things, fixed in scope, one flat monthly fee — {from} a month, {note}.', from: 'from $', per: '/month · quoted to your volume', cta: 'Everything in Found', addOn: 'Add-on' },
    brief: { eyebrow: 'Owner Daily Brief', h2: 'You don’t log into a dashboard. You get a text.', lede: 'One message every morning: calls answered, leads qualified, appointments booked, no-shows prevented, reviews posted, and which source produced the bookings. Then the single thing that needs a person.', body: 'Green is money that stayed. Amber is the one item waiting on you. If nothing is waiting on you, there is no amber line.' },
    industries: {
  ...
  es: {
    ...
    found: { eyebrow: 'Que te encuentren: qué incluye', h2: 'Qué incluye Found.', lede: 'Todo lo que tiene que estar en orden antes de que tu teléfono pueda sonar. Ocho cosas, alcance fijo, una sola cuota mensual: {from} al mes, {note}.', from: 'desde $', per: '/mes · cotizado a tu volumen', cta: 'Todo lo que incluye Found', addOn: 'Adicional' },
    brief: { eyebrow: 'Resumen diario del dueño', h2: 'No entras a un panel. Recibes un mensaje.', lede: 'Un mensaje cada mañana: llamadas contestadas, contactos calificados, citas agendadas, ausencias evitadas, reseñas publicadas y qué fuente produjo las citas. Luego, lo único que necesita a una persona.', body: 'Verde es dinero que se quedó. Ámbar es lo único que te espera. Si nada te espera, no hay línea ámbar.' },
    industries: {
